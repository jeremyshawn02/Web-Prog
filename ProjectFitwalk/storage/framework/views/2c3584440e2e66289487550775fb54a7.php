            ...
            <section class="col-lg-9 col-md-12 products">
                <div class="card mb-4 bg-light border-0 section-header">
                    <div class="card-body p-5">
                        <h2 class="mb-0">Tag: <?php echo e($tag->name); ?></h2>
                    </div>
                </div>
                <div class="row">
...
<?php echo $__env->make('themes.projectfitwalk.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Documents\Haooo\Web Prog\ProjectFitwalk\resources\views/themes/projectfitwalk/products/tag.blade.php ENDPATH**/ ?>