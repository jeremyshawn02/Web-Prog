                ...
                <div class="row">
                    <div class="d-lg-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex mt-2 mt-lg-0">
                            ...
                            <div>
                               <?php echo html()->select('sorting', $sortingOptions, $sortingQuery)->class(['form-select'])->attribute('onchange', 'this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);'); ?>
