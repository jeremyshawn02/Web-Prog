            ...
            <div class="col-md-6">
                <div id="product-images" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active"> <img src="<?php echo e(asset('img/logo.jpg')); ?>" alt="Product 1"> </div>
                        <div class="carousel-item"> <img src="<?php echo e(asset('img/logo.jpg')); ?>" alt="Product 2"> </div>
                        <div class="carousel-item"> <img src="<?php echo e(asset('img/logo.jpg')); ?>" alt="Product 3"> </div>
                        <div class="carousel-item"> <img src="<?php echo e(asset('img/logo.jpg')); ?>" alt="Product 4"> </div>
                    </div> <!-- Left right -->
                    ...
                    <ol class="carousel-indicators list-inline">
                        <li class="list-inline-item active"> <a id="carousel-selector-0" class="active" data-bs-slide-to="0" data-bs-target="#product-images"> <img src="<?php echo e(asset('img/logo.jpg')); ?>" class="img-fluid"> </a> </li>
                        <li class="list-inline-item"> <a id="carousel-selector-1" data-bs-slide-to="1" data-bs-target="#product-images">
                                <img src="<?php echo e(asset('img/logo.jpg')); ?>" class="img-fluid"> </a> </li>
            ...
            <div class="col-md-6">
                <div class="product-detail mt-6 mt-md-0">
                    ...
                    <div class="mb-3 rating">
                        ...
                        <a href="#" class="ms-2">(10 reviews)</a>
                    </div>
                    <div class="price">
                        <?php if($product->hasSalePrice): ?>
                            <span class="active-price text-dark">IDR <?php echo e($product->sale_price_label); ?></span>
                            <span class="text-decoration-line-through text-muted ms-1"><?php echo e($product->price_label); ?></span>
                            <span><small class="discount-percent ms-2 text-danger"><?php echo e($product->discount_percent); ?>% Off</small></span>
                        <?php else: ?>
                            <span class="active-price text-dark">IDR <?php echo e($product->price_label); ?></span>
                        <?php endif; ?>
                    </div>
                    <hr class="my-6">
                    ...
                    <div class="product-info">
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <td>Availability:</td>
                                    <td><?php echo e($product->stock_status_label); ?></td>
                                </tr>
                                <tr>
                                    <td>Type:</td>
                                    <td>Fruits</td>
                                ...
                                <tr>
                                    <td>Shipping:</td>
                                    <td><small>2 day shipping.<span class="text-muted">( Free pickup today)</span></small></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<?php echo $__env->make('themes.projectfitwalk.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Documents\Haooo\Web Prog\ProjectFitwalk\resources\views/themes/projectfitwalk/products/show.blade.php ENDPATH**/ ?>