            ...
            <div class="col-md-6">
                <div id="product-images" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active"> <img src="{{ asset('img/logo.jpg') }}" alt="Product 1"> </div>
                        <div class="carousel-item"> <img src="{{ asset('img/logo.jpg') }}" alt="Product 2"> </div>
                        <div class="carousel-item"> <img src="{{ asset('img/logo.jpg') }}" alt="Product 3"> </div>
                        <div class="carousel-item"> <img src="{{ asset('img/logo.jpg') }}" alt="Product 4"> </div>
                    </div> <!-- Left right -->
                    ...
                    <ol class="carousel-indicators list-inline">
                        <li class="list-inline-item active"> <a id="carousel-selector-0" class="active" data-bs-slide-to="0" data-bs-target="#product-images"> <img src="{{ asset('img/logo.jpg') }}" class="img-fluid"> </a> </li>
                        <li class="list-inline-item"> <a id="carousel-selector-1" data-bs-slide-to="1" data-bs-target="#product-images">
                                <img src="{{ asset('img/logo.jpg') }}" class="img-fluid"> </a> </li>
